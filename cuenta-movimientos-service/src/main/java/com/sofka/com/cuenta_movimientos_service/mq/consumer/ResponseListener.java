...
public class ResponseListener {
    ...
    // Método para asociar un CompletableFuture con un identificador único
    ...
    // Listener que procesa la respuesta desde la cola
    ...
    public void handleResponse(Map<String, String> response) {
        ...
        if (future != null) {
            future.complete(clienteName); // Completar la respuesta asíncrona
        }
    }
}
